    ...
    value: function bind() {
      ...
      if (self.$province) {
        self.$province.on(EVENT_CHANGE, self.onChangeProvince = $.proxy(function () {
			$('.sel1').text(self.$province.find(':selected').data('text'));
			$('.sel2').text('选择市');
			$('.sel3').text('选择区');
          self.output(CITY);
      ...
      if (self.$city) {
        self.$city.on(EVENT_CHANGE, self.onChangeCity = $.proxy(function () {
			$('.sel2').text(self.$city.find(':selected').data('text'));
			$('.sel3').text('选择区');
	  ...
	  if (self.$district) {
        self.$district.on(EVENT_CHANGE, self.onChangeDistrict = $.proxy(function () {
			$('.sel3').text(self.$district.find(':selected').data('text'));
        }, self));
      }
    }
  }, {
